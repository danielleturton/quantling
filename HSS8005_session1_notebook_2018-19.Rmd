...
You can find the slides from the first part of class [here](HSS8005_session1_slides_2018-19.html){target="_blank"}.

You can download the R notebook code (the output of which is this document) at the link by right clicking [here](HSS8005_session1_notebook_2018-19.Rmd) and choosing *save link/target as*.
