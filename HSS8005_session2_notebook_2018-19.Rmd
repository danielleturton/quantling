...
You can download the R notebook code (the output of which is this document) at the link by right clicking [here](HERE) and choosing *save link/target as*.  Store it in the same folder as last time.

You should already have the dialect data downloaded, but if not you can find it [here](HERE) and choosing *save link/target as*.
